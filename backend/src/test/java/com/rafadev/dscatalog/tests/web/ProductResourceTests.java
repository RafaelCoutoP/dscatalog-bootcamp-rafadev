package com.rafadev.dscatalog.tests.web;
...
import com.rafadev.dscatalog.dto.ProductDTO;
...
public class ProductResourceTests {
	...
	private String operatorPasswordName;
	
	
	@BeforeEach
	void setUp() throws Exception{
	operatorUserName = "alex@gmail.com";
	operatorPasswordName = "123456";		
	...
	public void deleteShouldNotFoundExceptionWhenIdDoesNotExist() throws Exception {
		String accessToken = obtainAccessToken(operatorUserName, operatorPasswordName);
	...
	public void updateShouldReturnProductDTOWhenIdExist() throws Exception {
		...
		String jsonBody = objectMapper.writeValueAsString(newProductDTO); // transforma o objeto Java em Json.
	...
	//Método que dado usuário e senha ele faz a requisição na api e retorna o access token.
